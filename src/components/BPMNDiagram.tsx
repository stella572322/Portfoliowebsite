...
export default function BPMNDiagram() {
  return <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-[#695aa6] to-[#543d8d] p-6">
        <h2 className="text-3xl text-white font-leckerli">
          BPMN 圖（業務流程模型與標記法）
        </h2>
        <p className="text-white/90 text-sm mt-2 font-patrick">
      ...
      <div className="p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center">
            <div className="mb-4">
              <h3 className="text-xl font-bold text-gray-700 text-center font-patrick">
                原始專案 BPMN 圖
              </h3>
              <p className="text-sm text-gray-500 text-center mt-1 font-patrick">
                （內容已模糊處理以保護機密資訊）
              </p>
            </div>
            <div className="relative w-full max-w-md bg-gray-100 rounded-lg overflow-hidden shadow-md">
              <img src={blurredImage} alt="原始 BPMN 圖（模糊）" className="w-full h-auto" style={{
              ...
              <div className="absolute top-4 right-4">
                <div className="bg-black/70 px-4 py-2 rounded-lg backdrop-blur-sm border border-white/30">
                  <p className="text-white text-xs font-bold text-center font-patrick">
                    🔒 圖片模糊化處理
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-2xl bg-gray-50 rounded-lg p-4 shadow-md overflow-auto" style={{
            backgroundImage: 'linear-gradient(#e0e0e0 1px, transparent 1px), linear-gradient(90deg, #e0e0e0 1px, transparent 1px)',
            backgroundSize: '20px 20px'
          }}>
              <svg width="900" height="1100" viewBox="0 0 900 1100" className="w-full h-auto">
                {/* Title */}
                <text x="450" y="30" textAnchor="middle" fontSize="18" fontWeight="bold" fill="#333" className="font-patrick">
                  BPMN 圖（階段性作業流程）
                </text>

                {/* Pool - Main Container */}
                <rect x="50" y="60" width="800" height="1000" fill="none" stroke="#333" strokeWidth="3" rx="5" />

                {/* Pool Label */}
                <text x="70" y="90" fontSize="16" fontWeight="bold" fill="#333" className="font-patrick">
                  專案管理系統
                </text>

                {/* Lane 1 - 執行單位 */}
                <rect x="50" y="110" width="400" height="950" fill="#E3F2FD" stroke="#1976D2" strokeWidth="2" opacity="0.3" />
                <text x="70" y="140" fontSize="14" fontWeight="bold" fill="#1976D2" className="font-patrick">
                  執行單位
                </text>

                {/* Lane 2 - 監督單位 */}
                <rect x="450" y="110" width="200" height="950" fill="#FFF3E0" stroke="#F57C00" strokeWidth="2" opacity="0.3" />
                <text x="470" y="140" fontSize="14" fontWeight="bold" fill="#F57C00" className="font-patrick">
                  監督單位
                </text>

                {/* Lane 3 - 主管單位 */}
                <rect x="650" y="110" width="200" height="950" fill="#F3E5F5" stroke="#7B1FA2" strokeWidth="2" opacity="0.3" />
                <text x="670" y="140" fontSize="14" fontWeight="bold" fill="#7B1FA2" className="font-patrick">
                  主管單位
                </text>

                {/* Horizontal Dividers for Phases */}
                <line x1="50" y1="160" x2="850" y2="160" stroke="#999" strokeWidth="1" strokeDasharray="5,5" />
                <text x="60" y="175" fontSize="11" fill="#666" className="font-patrick">段 1：選擇作業類型</text>

                <line x1="50" y1="310" x2="850" y2="310" stroke="#999" strokeWidth="1" strokeDasharray="5,5" />
                <text x="60" y="306" fontSize="11" fill="#666" className="font-patrick">階段 2：提交及上傳</text>

                <line x1="50" y1="520" x2="850" y2="520" stroke="#999" strokeWidth="1" strokeDasharray="5,5" />
                <text x="60" y="535" fontSize="11" fill="#666" className="font-patrick">階段 3：提交審核</text>

                <line x1="50" y1="680" x2="850" y2="680" stroke="#999" strokeWidth="1" strokeDasharray="5,5" />
                <text x="60" y="695" fontSize="11" fill="#666" className="font-patrick">階段 4：填寫資料及上傳文件</text>

                <line x1="50" y1="900" x2="850" y2="900" stroke="#999" strokeWidth="1" strokeDasharray="5,5" />
                <text x="60" y="915" fontSize="11" fill="#666" className="font-patrick">階段 5：提交審核</text>

                {/* Start Event - Circle */}
                <circle cx="250" cy="220" r="20" fill="white" stroke="#4CAF50" strokeWidth="3" />
                <text x="250" y="195" textAnchor="middle" fontSize="11" fill="#333" className="font-patrick">開始</text>
                ...
                <text x="250" y="307" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">選擇</text>
                <text x="250" y="322" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">部分作業項目</text>
                ...
                <text x="250" y="407" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">填寫</text>
                <text x="250" y="422" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">「報告表」</text>
                ...
                <text x="250" y="507" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">上傳「附件」+</text>
                <text x="250" y="522" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">「其他文件」</text>
                ...
                <text x="250" y="607" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">前置審核</text>
                ...
                <text x="550" y="772" textAnchor="middle" fontSize="11" fill="#333" className="font-patrick">上傳「報告」、</text>
                <text x="550" y="786" textAnchor="middle" fontSize="11" fill="#333" className="font-patrick">「日記」+相關之</text>
                <text x="550" y="800" textAnchor="middle" fontSize="11" fill="#333" className="font-patrick">作業紀錄表</text>
                ...
                <text x="550" y="897" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">填寫</text>
                <text x="550" y="912" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">「認證單」</text>
                ...
                <text x="415" y="1007" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">審查審核</text>
                ...
                <text x="735" y="1007" textAnchor="middle" fontSize="12" fill="#333" className="font-patrick">核定審核</text>
                ...
                <text x="250" y="1050" textAnchor="middle" fontSize="11" fill="#333" className="font-patrick">結束</text>
              </svg>
            </div>
          </div>
        </div>
