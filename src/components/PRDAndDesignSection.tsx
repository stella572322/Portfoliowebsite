...
export default function PRDAndDesignSection() {
  ...
  return <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="p-8">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold text-gray-800 mb-4 font-patrick">
            📄 PRD 分析文件摘要
          </h3>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 border-2 border-blue-200 shadow-md mb-6">
            ...
            <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-200">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-bold text-gray-800 font-patrick">
                  核心需求分析重點
                </h4>
              </div>
        ...
        <div className="mb-8">
          <div className="group relative bg-gray-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-blue-300 hover:border-[#695aa6] cursor-pointer" onClick={() => setSelectedImage(prdDocumentImage)}>
            {/* Document Badge */}
            <div className="absolute top-4 left-4 z-10">
              <div className="bg-[#695aa6] px-4 py-2 rounded-full shadow-lg">
                <p className="text-white text-sm font-bold font-patrick">
                  📋 完整 PRD 文件結構
                </p>
              </div>
            </div>
            ...
            <div className="relative bg-gray-100">
              <img src={prdDocumentImage} alt="PRD 文件結構圖" className="w-full h-auto transition-all duration-500 group-hover:scale-105" style={{
            ...
            {/* Description */}
              ...
              <h4 className="text-xl font-bold text-gray-800 mb-2 font-patrick">
                部分竣工驗收流程 - 完整 PRD 文件
              </h4>
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mb-4 font-patrick">
            以下設計稿已進行模糊處理以保護專案機密資訊，點擊可放大查看
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {figmaDesigns.map(design => <div key={design.id} className="group relative bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border-2 border-gray-200 hover:border-[#695aa6] cursor-pointer" onClick={() => setSelectedImage(design.imageUrl)}>
                {/* Phase Badge */}
                <div className="absolute top-3 left-3 z-10">
                    <div className="bg-[#695aa6] px-3 py-1 rounded-full shadow-lg">
                    <p className="text-white text-xs font-bold font-patrick">
                      {design.phase}
                    </p>
                  </div>
                </div>
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-gray-200">
                  <img src={design.imageUrl} alt={design.title} className="w-full h-full object-cover transition-all duration-500 group-hover:scale-105" style={{
                ...
                <div className="p-4 bg-white">
                  <h4 className="font-bold text-gray-800 mb-1 font-patrick">
                    {design.title}
                  </h4>
      ...
      {/* Image Modal */}
      {selectedImage && <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setSelectedImage(null)}>
          <div className="relative max-w-5xl w-full bg-white rounded-2xl overflow-hidden shadow-2xl">
            <button className="absolute top-4 right-4 z-10 bg-white hover:bg-gray-100 rounded-full p-2 shadow-lg transition-colors" onClick={() => setSelectedImage(null)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 6L6 18M6 6L18 18" stroke="#333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
            <img src={selectedImage} alt="放大檢視" className="w-full h-auto" style={{
          filter: 'blur(1.5px) brightness(1.05)'
        }} />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
              <p className="text-white text-center font-bold font-patrick">
                🔒 此圖片已模糊處理以保護專案機密資訊
              </p>
            </div>
          </div>
