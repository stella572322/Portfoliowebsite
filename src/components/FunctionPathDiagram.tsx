...
const ArrowDown = () => <div className="flex justify-center items-center py-6 relative z-10">
...
export default function FunctionPathDiagram() {
  return <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-[#695aa6] to-[#543d8d] p-8">
        <h2 className="text-3xl text-white mb-2 font-leckerli">
          功能路徑圖：驗收作業流程
        </h2>
        <p className="text-white/90 text-base font-patrick">
      ...
      <div className="p-8 bg-gray-50">
          ...
          <div className="flex flex-col">
            <div className="mb-4 bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-xl font-bold text-gray-700 font-patrick">
                  原始專案功能路徑圖
                </h3>
              </div>
              <p className="text-sm text-gray-500 font-patrick">
                內容已模糊處理以保護機密資訊
              </p>
            </div>
            <div className="relative bg-white rounded-xl overflow-hidden shadow-md flex-1">
              <img src={blurredImage} alt="原始功能路徑圖（模糊）" className="w-full h-full object-cover" style={{
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/10">
                <div className="bg-white/95 px-6 py-3 rounded-lg shadow-xl border-2 border-gray-300">
                  <p className="text-gray-700 text-base font-bold text-center font-patrick">
                    🔒 保密資訊已模糊化處理
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col">
            <div className="mb-4 bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-xl font-bold text-[#695aa6] font-patrick">
                  示範：專案驗收作業功能路徑
                </h3>
              </div>
              <p className="text-sm text-gray-600 font-patrick">
                通用範例，已將敏感字眼替換為通用術語
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-auto border-2 border-[#695aa6] flex-1">
              <div className="p-6 min-w-[500px]">
                ...
                <div className="bg-gradient-to-r from-[#695aa6] to-[#8b7bb8] rounded-xl p-4 mb-6 shadow-md">
                  <h4 className="text-base font-bold text-white text-center font-patrick">
                  ...
                  <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-b from-[#695aa6] to-[#543d8d] rounded-l-xl flex flex-col overflow-hidden">
                    <div className="flex-1 flex items-center justify-center border-b-2 border-white/30 py-4">
                      <div className="flex flex-col items-center gap-0.5">
                        ...
                        <span className="text-sm font-bold text-white font-patrick">專</span>
                        <span className="text-sm font-bold text-white font-patrick">案</span>
                        <span className="text-sm font-bold text-white font-patrick">負</span>
                        <span className="text-sm font-bold text-white font-patrick">責</span>
                        <span className="text-sm font-bold text-white font-patrick">人</span>
                      </div>
                    </div>
                    <div className="flex-1 flex items-center justify-center border-b-2 border-white/30 py-4">
                      <div className="flex flex-col items-center gap-0.5">
                        <span className="text-xl mb-1">🏢</span>
                        <span className="text-sm font-bold text-white font-patrick">管</span>
                        <span className="text-sm font-bold text-white font-patrick">理</span>
                        <span className="text-sm font-bold text-white font-patrick">單</span>
                        <span className="text-sm font-bold text-white font-patrick">位</span>
                      </div>
                    </div>
                    <div className="flex-1 flex items-center justify-center py-4">
                      <div className="flex flex-col items-center gap-0.5">
                        <span className="text-xl mb-1">✅</span>
                        <span className="text-sm font-bold text-white font-patrick">審</span>
                        <span className="text-sm font-bold text-white font-patrick">核</span>
                        <span className="text-sm font-bold text-white font-patrick">單</span>
                        <span className="text-sm font-bold text-white font-patrick">位</span>
                      </div>
                    </div>
                  ...
                  <div className="ml-28">
                    ...
                    <div className="mb-5 flex justify-center">
                      <div className="bg-gradient-to-r from-green-500 to-green-600 border-2 border-green-700 rounded-full px-6 py-3 shadow-lg">
                        <p className="text-sm font-bold text-white font-patrick">
                          🚀 開始：成果文件上傳
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      <div className="bg-gradient-to-r from-blue-100 to-blue-50 border-2 border-blue-400 rounded-xl p-4 mb-5 shadow-md">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <p className="text-sm font-bold text-blue-800 font-patrick">
                            步驟 1：上傳成果文件
                          </p>
                        </div>
                        <div className="ml-6 space-y-1">
                          <p className="text-xs text-gray-700 font-patrick">
                            • 填寫文件基本資料（標題、類別、版本）
                          </p>
                          <p className="text-xs text-gray-700 font-patrick">
                      ...
                      <div className="relative mx-auto w-64 h-48 mb-5">
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-48 h-48 bg-gradient-to-br from-yellow-100 to-yellow-200 border-4 border-yellow-500 shadow-lg transform rotate-45"></div>
                        </div>
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          <AlertCircle size={20} className="text-yellow-700 mb-2" />
                          <p className="text-sm font-bold text-yellow-800 text-center px-8 font-patrick">
                            資料是否完整？
                          </p>
                          <div className="mt-4 grid grid-cols-2 gap-4 text-xs font-bold font-patrick">
                    ...
                    <div className="mb-6">
                      <div className="bg-gradient-to-r from-green-100 to-green-50 border-2 border-green-400 rounded-xl p-4 mb-5 shadow-md">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <p className="text-sm font-bold text-green-800 font-patrick">
                            步驟 2：初審 - 文件格式檢查
                          </p>
                        </div>
                        <div className="ml-6 space-y-1">
                      ...
                      <div className="relative mx-auto w-64 h-48 mb-5">
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-48 h-48 bg-gradient-to-br from-orange-100 to-orange-200 border-4 border-orange-500 shadow-lg transform rotate-45"></div>
                        </div>
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          <AlertCircle size={20} className="text-orange-700 mb-2" />
                          <p className="text-sm font-bold text-orange-800 text-center px-8 font-patrick">
                            初審是否通過？
                          </p>
                          <div className="mt-4 grid grid-cols-2 gap-4 text-xs font-bold font-patrick">
                            <div className="flex items-center gap-1 text-red-600">
                    ...
                    <div className="mb-6">
                      <div className="bg-gradient-to-r from-purple-100 to-purple-50 border-2 border-purple-400 rounded-xl p-4 mb-5 shadow-md">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <p className="text-sm font-bold text-purple-800 font-patrick">
                            步驟 3：複審 - 內容實質查
                          </p>
                        </div>
                        <div className="ml-6 space-y-1">
                      ...
                      <div className="relative mx-auto w-64 h-48 mb-5">
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-48 h-48 bg-gradient-to-br from-pink-100 to-pink-200 border-4 border-pink-500 shadow-lg transform rotate-45"></div>
                        </div>
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          <AlertCircle size={20} className="text-pink-700 mb-2" />
                          <p className="text-sm font-bold text-pink-800 text-center px-8 font-patrick">
                            複審是否通過？
                          </p>
                          <div className="mt-4 grid grid-cols-2 gap-4 text-xs font-bold font-patrick">
                            <div className="flex items-center gap-1 text-red-600">
                      ...
                      <div className="bg-gradient-to-r from-green-100 to-emerald-100 border-2 border-green-500 rounded-xl p-4 shadow-md">
                        <div className="flex items-center gap-2 justify-center">
                          ...
                          <p className="text-sm font-bold text-green-700 font-patrick">
                            ✅ 核准通過，文件歸檔並通知相關人員
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="mt-8 pt-6 border-t-2 border-purple-300">
                      <p className="text-xs font-bold mb-3 text-[#695aa6] font-patrick">
                        📌 圖例說明：
                      </p>
                      <div className="grid grid-cols-2 gap-3 text-xs font-patrick">
        ...
        <div className="mt-8 bg-white p-6 rounded-xl shadow-md border-l-4 border-[#695aa6]">
          <h4 className="text-lg font-bold text-[#695aa6] mb-3 font-patrick">
            💡 流程設計重點
          </h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm font-patrick">
