        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative w-full max-w-md bg-gray-100 rounded-lg overflow-hidden shadow-md">
              <img src={blurredImage} alt="原始 RACI 表（模糊）" className="w-full h-auto" style={{
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-3xl bg-white rounded-lg shadow-md overflow-auto">
              <div className="p-4">
                {/* Title */}
                <h4 className="text-center text-lg font-bold text-gray-800 mb-2 font-patrick">
                  RACI 表（責任分配矩陣）
                </h4>
                <p className="text-center text-sm text-gray-600 mb-4 font-patrick">
                  【階段性作業提交流程】
                </p>
                  ...
                  <table className="w-full border-collapse border-2 border-gray-400">
                    <thead>
                      <tr className="bg-[#695aa6]">
                        <th className="border-2 border-gray-400 p-3 text-white text-left min-w-[200px] font-patrick">
                          Task \ Role
                        </th>
                        <th className="border-2 border-gray-400 p-3 text-white text-center min-w-[100px] font-patrick">
                          執行單位<br />(設計)
                        </th>
                        <th className="border-2 border-gray-400 p-3 text-white text-center min-w-[100px] font-patrick">
                          執行單位<br />(作業)
                    ...
                    <tbody>
                      ...
                      <tr className="bg-gray-50">
                        <td className="border-2 border-gray-400 p-3 font-semibold font-patrick">
                          選擇階段性作業項目
                        </td>
                      ...
                      {/* Row 5 */}
                      <tr className="bg-gray-50">
                        <td className="border-2 border-gray-400 p-3 font-semibold text-sm font-patrick">
                          上傳「照片」、「其他文件」、「紀錄表」
                        </td>
                        <td className="border-2 border-gray-400 p-3 text-center"></td>
                        <td className="border-2 border-gray-400 p-3 text-center"></td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-red-500">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h5 className="font-bold text-gray-700 text-sm font-patrick">
                  Accountable
                </h5>
              </div>
